...
public class Builder {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        Human notSmoker = new Human(false, "Bernhard", "Schwab", Gender.MALE, "24.09.1998", false, false);
        Human smoker = new Human(false, "Bernhard", "Schwab", Gender.MALE, "24.09.1998", true, false);
        notSmoker.breatheIn();
        smoker.breatheIn();
